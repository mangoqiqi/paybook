...
$(function ()
	{
 		 $('#calendar').calendar({ ifSwitch: true, /*是否切换月份*/hoverDate: true, /*hover是否显示当天信息份*/ backToday: true /*是否返回当天*/});
	}
);
...
//显示hover日期------
    ...
    showCalendar: function (){ // 输入数据并显示
      ...
      this.$calendarDate_item.each(function (i) {
		...
		var money=1777;
		allDay.getDate()
        var String1="<p style=\"height:20px\">"+allDay.getDate()+"</p>";
		var String2="<p style=\"height:30px;font-size:16px;color:#7CCD7C;\">"+money+"</p>";
        $(this).html(String1+String2).attr('data', allDay_str);
